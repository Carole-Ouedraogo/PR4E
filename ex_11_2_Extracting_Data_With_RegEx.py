...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_249174.txt
(There are 61 values and the sum ends with 345)
...
import re
print (sum([int(i) for i in re.findall('[0-9]+',open("C:\\Users\\sweet\\OneDrive\\Desktop\\Professional\\DATA Analytics\\Python Learning\\regex_sum_249174.txt").read())]))

file = open("C:\\Users\\sweet\\OneDrive\\Desktop\\Professional\\DATA Analytics\\Python Learning\\regex_sum_42.txt", 'r')
sum = 0
for line in file:
